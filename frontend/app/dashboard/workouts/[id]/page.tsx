    ...
    return (
        <div className="max-w-4xl mx-auto pb-12">
            ...
            <div className="mb-6 flex items-center">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white truncate">{workout.title}</h1>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-700 mb-8">
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4 text-sm">
                    <div>
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Scheduled For</p>
                    ...
                    <div>
                        ...
                        <p className="text-gray-900 dark:text-white font-semibold mt-1">{workout.duration_min} min</p>
                    </div>
                    <div>
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Source</p>
                        <p className="text-gray-900 dark:text-white font-semibold mt-1 uppercase">{workout.source}</p>
                    </div>
                    <div>
            ...
            <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Logged Exercises</h2>
                ...
                {!logsError && (!logs || logs.length === 0) ? (
                    <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No sets logged yet</h3>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Record your first exercise down below.</p>
                    </div>
                ) : (
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50 dark:bg-gray-800/50">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sets x Reps</th>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Time Logged</th>
